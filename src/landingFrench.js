        ...
        <>
            ...
            <div class="language-flag">
                    <a onClick={props.changeToEnglish} href="#">
                        <img src="assets/images/englishLogo.png" height="20px" class="heading-desktop" alt=""/>
                        <img src="assets/images/englishLogo.png" height="10px" class="heading-mobile" alt=""/>
                    </a>
                </div>
                        ...
                        <div className="row">
                            ...
                            <div className=" col-md-4">
                                    <div className="project-inner" id="project-inner02">
                                        ...
                                        <h2 className="heading-desktop"> Le fan détient la propriété <br/>
                                            de l’oeuvre</h2>
                                        <h2 className="heading-mobile"> Le fan détient  <br/> la propriété
                                            de l’oeuvre</h2>
                                ...
                                <div className="row">
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                                ...
                                                <h6 className="heading-mobile"><span><strong>Les gros labels</strong> se font de l’argent sur le dos des petits artistes </span></h6>
                    ...
                    <div className="container">
                        <div className="row">
                            ...
                            <div className="sec-04">
                                <div className="row">
                                    <div className="col-md-6 col-6">
                                        <p><strong>Entrez votre email et proposez votre <span className="heading-desktop"> </span> musique favorite.</strong><span className="heading-mobile"></span> Si le son est validé, nous l’afficherons sur notre playlist
                    ...
                    <div className="container">
                        <div className="row">
                            ...
                            <div className="circle02">
                                ...
                                <p>Ne pas avoir Signé dans un gros label comme Universal/Sony</p>
                            </div>
